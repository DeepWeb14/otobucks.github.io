                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 d-flex justify-content-center align-items-center mt-lg-5 pt-lg-5">
                            <div className="container">
                                <h1 className="mb-4">Premium Car  <span>Dealer</span></h1>
                                <p className="mb-2" style={{ lineHeight: '30px' }}>Explore our exceptional collection of high-quality vehicles, meticulously handpicked
                        ...
                        <div className="col-lg-6 p-0 img_bg">
                            <img className="img-fluid pt-5" src="images/pngwing 23.png" alt="" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-lg-7">
                            <h1 className="mb-4">Where You <span>Dream Cars Wait! </span></h1>
